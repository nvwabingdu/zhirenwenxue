package com.example.zrwenxue.moudel.main.word.pickerandpop;
...
public class CommonPopWindow {
    ...
    private static ZqrBuilder mBuilder;
    ...
    private CommonPopWindow() {
        mBuilder = new ZqrBuilder();
    }

    /**
     * 通过newBuilder方法，创造构建者模式
     * @return
     */
    public static ZqrBuilder newBuilder() {
        if (mBuilder == null) {
            mBuilder = new ZqrBuilder();
        }
        return mBuilder;
...
//                mPopupWindow.showAsDropDown(view, 0, -(getHeight() + view.getMeasuredHeight()));
     ...
     * 构建者模式  使用Builder类
     */
    public static class ZqrBuilder implements PopupWindow.OnDismissListener {
        ...
        /**
         * 通过ZqrBuilder的build方法，返回构建好的CommonPopWindow示例
         * @param context
         * @return
         */
        public CommonPopWindow build(Context context) {
            ...
            apply();
            if (mListener != null && mLayoutResId != 0) {//设置了监听并且加载了子控件
         ...
         * @return
         */
        public ZqrBuilder setView(@LayoutRes int layoutResId) {
            mContentView = null;
         ...
         * @return
         */
        public ZqrBuilder setSize(int width, int height) {
            mWidth = width;
            mHeight = height;
            return this;
        }
         ...
         * @return
         */
        public ZqrBuilder setBackgroundDrawable(Drawable drawable) {
            mDrawable = drawable;
            return this;
        }
         ...
         * @return
         */
        public ZqrBuilder setBackgroundDarkEnable(boolean darkEnable) {
         ...
         * @return
         */
        public ZqrBuilder setBackgroundAlpha(@FloatRange(from = 0.0, to = 1.0) float dackAlpha) {
         ...
         * @return
         */
        public ZqrBuilder setOutsideTouchable(boolean touchable) {
         ...
         * @return
         */
        public ZqrBuilder setTouchable(boolean touchable) {
         ...
         * @return
         */
        public ZqrBuilder setAnimationStyle(@StyleRes int animationStyle) {
         ...
         * @return
         */
        public ZqrBuilder setFocusable(boolean focusable) {
        ...
        public ZqrBuilder setViewOnClickListener(ViewClickListener listener) {
