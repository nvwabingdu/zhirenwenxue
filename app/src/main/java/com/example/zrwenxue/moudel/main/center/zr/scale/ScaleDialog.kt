package com.example.zrwenxue.moudel.main.center.zr.scale;
 ...
 * 样式可根据需求而定
 * **/
class ScaleDialog(context: Context) : Dialog(context, android.R.style.Theme_Translucent_NoTitleBar_Fullscreen) {
    private var contentView: ViewGroup? = null
    private var shadowView: View? = null
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.home_dialog_scale)
