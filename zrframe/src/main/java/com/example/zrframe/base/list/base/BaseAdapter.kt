...
import com.example.zrframe.base.list.multitype.MultiTypeAdapter
import com.example.zrframe.item.BannerViewDelegate
import com.example.zrframe.item.CatagoryListViewDelegate
import com.example.zrframe.item.CatagoryViewDelegate
import com.example.zrframe.item.GoodsViewDelegate
import com.example.zrframe.item.LargeVideoViewDelegate
import com.example.zrframe.item.LoadMoreViewDelegate
import com.example.zrframe.item.Test1ViewDelegate
import com.example.zrframe.item.Test2ViewDelegate
import com.example.zrframe.item.VideoViewDelegate
