package com.example.zrframe.util
...
import com.example.zrframe.module.main.ZrMainActivity
import java.util.*
    ...
    fun init(application: Application) {
        application.registerActivityLifecycleCallbacks(object : Application.ActivityLifecycleCallbacks {
            ...
            override fun onActivityPaused(activity: Activity) {
                ...
                if (activityStack.size == 1 && activity.isFinishing && activity !is ZrMainActivity) {
                    val intent = Intent(activity, ZrMainActivity::class.java)
