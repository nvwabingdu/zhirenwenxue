package cn.dreamfruits.yaoguo.module.main.home.phonebook.finduser
 ...
 * @TIME 23:23
 */
class FindUserAdapter (var mContent: Context, private var dataList:MutableList<SearchUserBean.Item>) : RecyclerView.Adapter<FindUserAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            Singleton.startOtherUserCenterActivity(mContent,dataList[position].userId)//通讯录是userid
        }
    }
        ...
        careUserTv.setOnClickListener {
            ...
            when(relation){//关系 0:未关注 1:我关注他 2:他关注我 3:互相关注
                0->{//未关注
                    ...
                    mInterface!!.onCareUser(dataList[position].id,true)
                    //fans人数加一
                ...
                1->{//我关注他
                    ...
                    mInterface!!.onCareUser(dataList[position].id,false)
                    //fans人数减一
                    dataList[position].followerCount=dataList[position].followerCount-1
                }
                2->{//他关注我
     ...
     */
        ...
        fun setFindUserAdapterCallBack(mInterface: InnerInterface){
