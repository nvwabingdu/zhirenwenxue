package cn.dreamfruits.yaoguo.view.swipe;
...
/*        mScroller.startScroll(getScrollX(), 0, -getScrollX(), 0);
        ...
        if (mOnSwipeClose != null) {
            mOnSwipeClose.onSwipeClose();
        }
...
/*    @Override
    ...
    OnSwipeClose mOnSwipeClose;

    public void setOnSwipeClose(OnSwipeClose onSwipeClose) {
        mOnSwipeClose = onSwipeClose;
    }

    public interface OnSwipeClose {
        void onSwipeClose();
    }
