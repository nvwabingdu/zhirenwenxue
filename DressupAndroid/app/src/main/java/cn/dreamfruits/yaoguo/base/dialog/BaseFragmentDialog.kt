package cn.dreamfruits.yaoguo.base.dialog
...
import cn.dreamfruits.yaoguo.extention.isDoubleClick
import cn.dreamfruits.yaoguo.extention.setBackgroundAlpha
...
//        super.show(manager, tag)
    ...
    private fun setBooleanField(fieldName: String, value: Boolean) {
        try {
            val field = androidx.fragment.app.DialogFragment::class.java.getDeclaredField(fieldName)
    ...
    private fun setStyle() {
        ...
        //设置偏移量
        wlp.x = SizeUtil.dp2px(mOffsetX.toFloat())
        wlp.y = SizeUtil.dp2px(mOffsetY.toFloat())
