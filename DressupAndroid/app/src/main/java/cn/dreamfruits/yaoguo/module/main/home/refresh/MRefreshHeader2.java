...
public class MRefreshHeader2 extends LinearLayout implements RefreshHeader {
     ...
     * 1，构造方法
     */
    public MRefreshHeader2(Context context) {
        this(context, null, 0);
    }

    public MRefreshHeader2(Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public MRefreshHeader2(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        View view = View.inflate(context, R.layout.m_refresh_header3, this);
...
//                mImage.setImageResource(R.drawable.loading_37);
//                break;
            //2,下拉到最底部的状态：释放立即刷新
