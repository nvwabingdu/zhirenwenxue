package cn.dreamfruits.yaoguo.module.main.home.child.controller;
 ...
 * @TIME 11:23
 */
public class AttentionItemVideoController extends BaseVideoController {
    ...
    public AttentionItemVideoController(@NonNull Context context) {
        this(context, null);
    }

    public AttentionItemVideoController(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public AttentionItemVideoController(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
