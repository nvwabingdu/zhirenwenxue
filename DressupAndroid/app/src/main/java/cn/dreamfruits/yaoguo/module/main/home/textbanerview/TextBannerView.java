package cn.dreamfruits.yaoguo.module.main.home.textbanerview;
...
import cn.dreamfruits.yaoguo.util.DisplayUtils;


/**
 * https://github.com/ChessLuo/TextBannerView
 * @描述 文字自动轮播（跑马灯）
 *
...
public class TextBannerView extends RelativeLayout{
    ...
    private int mInterval = 2000;/**文字切换时间间隔,默认2s*/
    private boolean isSingleLine = false;/**文字是否为单行,默认false*/
    private int mTextColor = 0xff949494;/**设置文字颜色,默认黑色*/
    ...
    @AnimRes
    private int inAnimResId = R.anim.textbannerview_anim_right_in;
    @AnimRes
    private int outAnimResId = R.anim.textbannerview_anim_left_out;
    private boolean hasSetAnimDuration = false;
    private int animDuration = 500;/**默认1.5s*/
        ...
        if (hasSetDirection) {
            switch (direction) {
                case DIRECTION_BOTTOM_TO_TOP:
                    inAnimResId = R.anim.textbannerview_anim_bottom_in;
                    outAnimResId = R.anim.textbannerview_anim_top_out;
                    break;
                case DIRECTION_TOP_TO_BOTTOM:
                    inAnimResId = R.anim.textbannerview_anim_top_in;
                    outAnimResId = R.anim.textbannerview_anim_bottom_out;
                    break;
                case DIRECTION_RIGHT_TO_LEFT:
                    inAnimResId = R.anim.textbannerview_anim_right_in;
                    outAnimResId = R.anim.textbannerview_anim_left_out;
                    break;
                case DIRECTION_LEFT_TO_RIGHT:
                    inAnimResId = R.anim.textbannerview_anim_left_in;
                    outAnimResId = R.anim.textbannerview_anim_right_out;
                    break;
            }
        } else {
            inAnimResId = R.anim.textbannerview_anim_right_in;
