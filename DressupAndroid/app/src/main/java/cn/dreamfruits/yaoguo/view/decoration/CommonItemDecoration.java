...
public class CommonItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public CommonItemDecoration(int horizontalSpace ,int leftMargin,int rightMargin){
        this(horizontalSpace,0,leftMargin,0,rightMargin,0);
    }
    ...
    public CommonItemDecoration(int horizontalSpace, int verticalSpace, int leftMargin, int topMargin, int rightMargin, int bottomMargin) {
        this.horizontalSpace = SizeUtil.INSTANCE.dp2px(horizontalSpace);
        this.verticalSpace = SizeUtil.INSTANCE.dp2px(verticalSpace);
        this.leftMargin =  SizeUtil.INSTANCE.dp2px(leftMargin);
        this.topMargin =  SizeUtil.INSTANCE.dp2px(topMargin);
        this.rightMargin =  SizeUtil.INSTANCE.dp2px(rightMargin);
        this.bottomMargin =  SizeUtil.INSTANCE.dp2px(bottomMargin);
    }
