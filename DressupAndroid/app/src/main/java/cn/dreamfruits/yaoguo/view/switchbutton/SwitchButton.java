package cn.dreamfruits.yaoguo.view.switchbutton;
...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        checkLineWidth = optPixelSize(typedArray,
                ...
                dp2pxInt(0f));//dp2pxInt(1.0f);//wq

        checkLineLength = dp2px(0);//wq
     ...
     * @param canvas
     */
    private void drawUncheckIndicator(Canvas canvas) {//wq
//        drawUncheckIndicator(canvas,
//                uncheckCircleColor,
//                uncheckCircleWidth,
