 ...
 * @desc :
 */
class ShareSinglePop(
    var mContext: Context,
    var mSingleGoods: GetClothesItemInfoBean,
    ...
    override fun onCreate() {
        ...
        tv_desc.text = mSingleGoods.name
        iv_cover_img.loadRectImg(mContext, mSingleGoods.coverUrls.first())
        iv_head_img.loadRoundImg(mContext, mSingleGoods.userInfo!!.avatarUrl.decodePicUrls())
        tv_nick_name.text = mSingleGoods.userInfo!!.nickName
        ...
        mSingleGoods.clothesList.forEach {
            list.add(it.picUrl)
        }
