 ...
 * @TIME 16:51
 *
 * https://blog.csdn.net/duoduo_11011/article/details/53606150
 *
 * 使用方法
 *	private void showPopBottom(){
 *         CommonPopupWindow popWindow = new CommonPopupWindow.PopupWindowBuilder(this)
 ...
 *         //创建并显示popWindow
 *         mCustomPopWindow= new CommonPopupWindow.PopupWindowBuilder(this)
 *                 .setView(contentView)
 *                 .create()
...
public class CommonPopupWindow implements PopupWindow.OnDismissListener {
    ...
    public CommonPopupWindow showAsDropDown(View anchor){
        if(mPopupWindow!=null){
     ...
     * @return
     */
    public CommonPopupWindow showAtLocation(View parent, int gravity, int x, int y){
        if(mPopupWindow!=null){
    ...
    public static class PopupWindowBuilder{
        ...
        public PopupWindowBuilder(Context context){
            mCustomPopWindow = new CommonPopupWindow(context);
        }
