package cn.dreamfruits.yaoguo.view.bubble;
...
public class BubbleView extends ViewGroup {
    ...
    private IndicatorDirection mIndicatorDirection = IndicatorDirection.BOTTOM;//箭头方向
...
//                break;
            case 1:
                ...
                break;
            case 2:
                mIndicatorDirection = IndicatorDirection.RIGHT;
                break;
            case 3:
                mIndicatorDirection = IndicatorDirection.BOTTOM;
                break;
            default:
                mIndicatorDirection = IndicatorDirection.LEFT;
                break;
        }
...
//        // ③根据最新的高度来重新生成heightMeasureSpec(高度模式是确定模式)
        ...
        if (heightMode != MeasureSpec.EXACTLY) {
            ...
            if ((mIndicatorDirection == IndicatorDirection.TOP || mIndicatorDirection == IndicatorDirection.BOTTOM) && !isFillIndicator)
