package cn.dreamfruits.yaoguo.module.login.bean;
...
import cn.dreamfruits.yaoguo.module.login.TUIKitConstants;
...
public class UserInfo implements Serializable {
    ...
    public synchronized static UserInfo getInstance() {
        if (sUserInfo == null) {
            SharedPreferences shareInfo = MainApp.Companion.getMContext().getSharedPreferences(TUIKitConstants.USERINFO, 0);
