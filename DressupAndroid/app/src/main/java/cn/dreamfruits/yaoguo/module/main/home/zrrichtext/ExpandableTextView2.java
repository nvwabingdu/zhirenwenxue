...
public class ExpandableTextView2 extends AppCompatTextView {
    ...
    private int mOpenSuffixColor=Color.parseColor("#333333"), mCloseSuffixColor=Color.parseColor("#333333");//展开和收起的颜色


    private ArrayList<ExpandableTextView.RichTextBean> mRichTextBeanList=new ArrayList<>();
...
//                                    mRichTextInterface.onclick(tempName,tempType);
                                    ...
                                    intent.putExtra("contentStr", tempName);
    ...
    public void setRichTextList(ArrayList<ExpandableTextView.RichTextBean> mList) {
    ...
    private void close() {
        if (hasAnimation) {
            ...
            ExpandableTextView2.super.setMaxLines(mMaxLines);
            setText(mCloseSpannableStr);
            if (mOpenCloseCallback != null){
...
private Layout createStaticLayout(SpannableStringBuilder spannable) {
    ...
    public static class RichTextBean {
        ...
        public String toString() {
            return "AtTextBean=>|" + singleStr +"|"+ index +"|"+ len +"|"+ userId +"|"+ name+"|"+type+"|"+colorStr;
        }

        public RichTextBean(String singleStr, int index, int len, String userId, String name) {
        ...
        public RichTextBean(String singleStr, int index, int len, String userId, String name, String type, String colorStr) {
            this.singleStr = singleStr;
            this.index = index;
            this.len = len;
            this.userId = userId;
