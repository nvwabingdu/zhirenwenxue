...
public class PrivateConstants {
    ...
    public static long huaweiPushBussinessId = 30206;
    ...
    public static String huaweiBadgeClassName = "cn.dreamfruits.yaoguo.module.splash.SplashActivity";
    /****** huawei end ******/
    ...
    /****** vivo begin******/
    // 在腾讯云控制台上传第三方推送证书后分配的证书ID  // The certificate ID assigned in the Tencent Cloud console
    public static long vivoPushBussinessId = 30222;
    // 海外证书 ID，需要在海外控制台配置，不使用不用填写  // The overseas certificate ID, which needs to be configured on the overseas console, does not need to be filled in if it is not used.
    ...
    /****** oppo begin ******/
    // 在腾讯云控制台上传第三方推送证书后分配的证书ID  // The certificate ID assigned in the Tencent Cloud console
    public static long oppoPushBussinessId = 30198;
    // 海外证书 ID，需要在海外控制台配置，不使用不用填写  // The overseas certificate ID, which needs to be configured on the overseas console, does not need to be filled in if it is not used.
    public static long oppoPushBussinessIdAbroad = 0;
    // oppo开放平台分配的应用APPID及APPKEY  // APPID APPKEY, Allocated by OPPO Open Platform
    public static String oppoPushAppKey = "b3efaa6c131545fb9b7ab45a500a1ac2";
    public static String oppoPushAppSecret = "e0cd89294a0c46bf949e22c5526bc1e1";
    /****** oppo end ******/

    /****** honor start ******/
    // 在腾讯云控制台上传第三方推送证书后分配的证书ID
    public static long honorPushBussinessId = 30208;
