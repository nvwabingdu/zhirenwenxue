package cn.dreamfruits.yaoguo.module.OEMPush.services;
...
import cn.dreamfruits.yaoguo.module.OEMPush.config.InitSetting;
import cn.dreamfruits.yaoguo.module.OEMPush.utils.Constants;
...
public class TIMAppService extends ServiceInitializer implements ITUIService, ITUINotification {
    ...
    public void onNotifyEvent(String key, String subKey, Map<String, Object> param) {
        ...
        } else if (TUIConstants.TIMAppKit.NOTIFY_RTCUBE_EVENT_KEY.equals(key)
                && TUIConstants.TIMAppKit.NOFITY_IMLOGIN_SUCCESS_SUB_KEY.equals(subKey)) {
            if (param != null) {
