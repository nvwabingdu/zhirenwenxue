...
import cn.dreamfruits.yaoguo.module.OEMPush.services.ServiceInitializer;
...
import cn.dreamfruits.yaoguo.module.main.message.chart.interfaces.ITUIService;
...
public class TUIOfflinePushService extends ServiceInitializer implements ITUINotification, ITUIService {
        ...
        if (appContext instanceof Application) {
            ...
            ((Application) appContext).registerActivityLifecycleCallbacks(new Application.ActivityLifecycleCallbacks() {
                ...
                public void onActivityCreated(Activity activity, Bundle bundle) {
                    LogUtils.i(TAG, "onActivityCreated bundle: " + bundle);
                }
                ...
                public void onActivityStarted(Activity activity) {
                    ...
                    if (foregroundActivities == 1 && !isChangingConfiguration) {
                        LogUtils.i(TAG, "application enter foreground");
                        V2TIMManager.getOfflinePushManager().doForeground(new V2TIMCallback() {
                            @Override
                            public void onError(int code, String desc) {
                                LogUtils.e(TAG, "doForeground err = " + code + ", desc = " + ErrorMessageConverter.convertIMError(code, desc));
                            }

                            @Override
                            public void onSuccess() {
                                LogUtils.i(TAG, "doForeground success");
                            }
                        });

                        V2TIMManager.getConversationManager().addConversationListener(unreadListener);
                        TUICore.registerEvent(
                            TUIConstants.TUIConversation.EVENT_UNREAD,
                                TUIConstants.TUIConversation.EVENT_SUB_KEY_UNREAD_CHANGED, unreadNotification);
                    }
                ...
                public void onActivityStopped(Activity activity) {
                    ...
                    if (foregroundActivities == 0) {
                        LogUtils.i(TAG, "application enter background");
                        V2TIMManager.getOfflinePushManager().doBackground((int) totalUnread, new V2TIMCallback() {
                            @Override
                            public void onError(int code, String desc) {
                                LogUtils.e(TAG, "doBackground err = " + code + ", desc = " + ErrorMessageConverter.convertIMError(code, desc));
                            }

                            @Override
                            public void onSuccess() {
                                LogUtils.i(TAG, "doBackground success");
                            }
                        });
                        ...
                        TUICore.unRegisterEvent(
                            TUIConstants.TUIConversation.EVENT_UNREAD,
                                TUIConstants.TUIConversation.EVENT_SUB_KEY_UNREAD_CHANGED,
                                unreadNotification);
                    }
    ...
    @Override
    public void onNotifyEvent(String key, String subKey, Map<String, Object> param) {
        LogUtils.d(TAG, "onNotifyEvent key = " + key + "subKey = " + subKey);
    ...
    public Object onCall(String method, Map<String, Object> param) {
        LogUtils.d(TAG, "onCall method = " + method);
