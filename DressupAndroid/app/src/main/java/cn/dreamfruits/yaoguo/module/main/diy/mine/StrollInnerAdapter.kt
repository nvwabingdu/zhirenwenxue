 ...
 * @TIME 23:52
 */
class StrollInnerAdapter (private var mContent: Context,
                          private var dataList:MutableList<GetStyleVersionListByTypeBean.Item>) :
    RecyclerView.Adapter<StrollInnerAdapter.MyViewHolder>() {
...
//            .load(dataList[position].coverUrl)
    ...
    fun setStrollInnerAdapterCallBack(mInterface: InnerInterface) {
