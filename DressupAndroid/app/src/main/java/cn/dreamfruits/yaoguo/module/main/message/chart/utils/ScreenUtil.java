...
public class ScreenUtil {
    ...
    public static int getPxByDp(float dp) {
        float scale = MainApp.Companion.getMContext().getResources().getDisplayMetrics().density;
    ...
    public static int dip2px(float dpValue) {
        final float scale = MainApp.Companion.getMContext().getResources().getDisplayMetrics().density;
