package com.zr.video.old.controller;
...
import com.zr.video.config.VideoInfoBean;
import com.zr.video.old.dialog.ChangeClarityDialog;
import com.zr.video.old.listener.OnClarityChangedListener;
import com.zr.video.old.listener.OnPlayerStatesListener;
import com.zr.video.old.listener.OnPlayerTypeListener;
import com.zr.video.old.listener.OnVideoControlListener;
import com.zr.video.old.other.BatterReceiver;
import com.zr.video.old.other.NetChangedReceiver;
...
/**
 * 播放器控制器，主要是处理UI操作逻辑  注意：建议先判断状态，再进行设置参数
 */
