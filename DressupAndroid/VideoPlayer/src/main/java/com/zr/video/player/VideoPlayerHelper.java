...
import com.zr.video.controller.BaseVideoController;
...
public class VideoPlayerHelper {
     ...
     */
    public ViewGroup getDecorView(Context context, BaseVideoController videoController) {
     ...
     * @param videoController                       controller
     */
    public ViewGroup getContentView(Context context, BaseVideoController videoController) {
        Activity activity = VideoPlayerHelper.instance().getActivity(context,videoController);
        if (activity == null) {
            return null;
        }
     ...
     * @param videoController                       controller
     */
    public void showSysBar(ViewGroup decorView, Context context, BaseVideoController videoController) {
     ...
     * @param videoController                       controller
     */
    public void hideSysBar(ViewGroup decorView, Context context, BaseVideoController videoController) {
        int uiOptions = decorView.getSystemUiVisibility();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.JELLY_BEAN) {
            uiOptions |= View.SYSTEM_UI_FLAG_HIDE_NAVIGATION;
        }
     ...
     * @return                                      是否为本地数据源
     */
    public boolean isLocalDataSource(String url, AssetFileDescriptor assetFileDescriptor) {
