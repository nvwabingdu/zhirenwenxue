...
public final class ConstantKeys {
    ...
    public @interface PlayerScreenScaleType {
        int SCREEN_SCALE_DEFAULT = 0;//默认类型
        int SCREEN_SCALE_16_9 = 1;//16：9比例类型，最为常见
        int SCREEN_SCALE_4_3 = 2;//4：3比例类型，也比较常见
        int SCREEN_SCALE_MATCH_PARENT = 3;//充满整个控件视图
        int SCREEN_SCALE_ORIGINAL = 4;//原始类型，指视频的原始类型
        int SCREEN_SCALE_CENTER_CROP = 5;//居中裁剪类型
    }
