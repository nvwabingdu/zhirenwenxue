...
abstract class BitmapTransformation : Transformation<Bitmap> {
     ...
     * 获取一个缩放到给定宽高比的图片
     */
    protected fun zoomBitmap(pool: BitmapPool, bitmap: Bitmap, outWidth: Int, outHeight: Int): Bitmap {
        ...
        val newBitmap: Bitmap = pool.get(newWidth.toInt(), newHeight.toInt(), Bitmap.Config.ARGB_8888)
