...
import cn.dreamfruits.baselib.network.imageloader.CornerType
 ...
 *@author: YangYang.
 */
class RoundedCornersTransformation @JvmOverloads constructor(private val radius: Int, private val margin: Int,
