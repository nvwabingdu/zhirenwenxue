...
public class GlideRequests extends RequestManager {
  ...
  protected void setRequestOptions(@NonNull RequestOptions toSet) {
    if (toSet instanceof cn.dreamfruits.baselib.network.imageloader.glide.GlideOptions) {
      super.setRequestOptions(toSet);
    } else {
      super.setRequestOptions(new cn.dreamfruits.baselib.network.imageloader.glide.GlideOptions().apply(toSet));
    }
  }
}
