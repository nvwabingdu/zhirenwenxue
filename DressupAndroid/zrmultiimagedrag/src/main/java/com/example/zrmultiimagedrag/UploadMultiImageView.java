...
import com.example.zrmultiimagedrag.bean.AddBean;
import com.example.zrmultiimagedrag.imp.ImageAddClickListener;
import com.example.zrmultiimagedrag.imp.ImageDeleteClickListener;
import com.example.zrmultiimagedrag.imp.ImageInfo;
import com.example.zrmultiimagedrag.imp.ImageItemClickListener;
import com.example.zrmultiimagedrag.imp.ImageViewLoader;
import com.example.zrmultiimagedrag.utils.HHDensityUtils;
...
public class UploadMultiImageView extends RecyclerView {
     ...
     */
    public UploadMultiImageView setImageInfoList(ArrayList<ImageInfo> imageInfoList) {
    ...
    private void addViewData() {
        ...
        if (maxNumber > 0 && maxNumber < imageInfoList.size()) { // 超出最大显示值，直接截取
            imageInfoList = (ArrayList<ImageInfo>) imageInfoList.subList(0, maxNumber);
        }
    }
     ...
     * adapter
     */
    private class UploadImageAdapter extends Adapter<UploadImageAdapter.MyViewHolder> {
    ...
    private class ItemDragTouchCallback extends ItemTouchHelper.Callback {
         ...
         */
        @Override
        public boolean canDropOver(@NonNull RecyclerView recyclerView, @NonNull ViewHolder viewHolder, @NonNull ViewHolder target) {
